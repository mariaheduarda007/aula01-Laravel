...
@section('conteudo')
    ...
    <table class="table align-middle caption-top table-striped">
        <thead>
            ...
            <th class="d-none d-md-table-cell text-secondary">DURACAO</th>
            ...
            @foreach ($cursos as $item)
                <tr>
                    ...
                    <td>
                        ...
                        <a nohref style="cursor:pointer" onclick="showRemoveModal('{{ $item->id }}', '{{ $item->nome }} - {{ $item->duracao }}')" class="btn btn-outline-danger">
